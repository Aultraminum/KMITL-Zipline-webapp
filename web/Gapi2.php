...
<center><h1 style="font-size: 70px;">เส้นทางที่2</h1>
<img src="Gapi2.png" width="100%" alt="icon" border="5">
<form>
<input class="button" type="button" value="Home" onclick="window.location.href='Zipline.php'" />
<input class="button" type="button" value="Back" onclick="window.location.href='Gapi.php'" />
</form>
<br><br>
