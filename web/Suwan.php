...
<img height="200" width="200" src="SuwanIC.png" alt="icon">
...
<p style="font-size: 30px";>คุณเลือกที่จะไป สนามบินสุวรรณภูมิ</p>
<p style="font-size: 30px";>You choose to go to Suwannabhumi Airport</p>

<form action="Suwan.php" method="post">
  ความต้องการ :
...
$sql = "SELECT Path, Walk, Taxi, Want, Price, Time FROM Suwan";
...
if(!isset($_POST['submit'])) {
    ...
    while($row = $result->fetch_assoc()) {
          ...
          echo '<td><input class="buttonin" type="button" name="submit'.$id.' " value="Go" onclick="window.location.href=\'Suwan'.$row['Path'].'.php\'" ></td>';
          echo "</tr>";
    $x++;
    $id++;
    }
