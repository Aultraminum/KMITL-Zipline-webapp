...
<img height="200" width="200" src="GapiIC.png" alt="icon">
...
$sql = "SELECT Path, Walk, Taxi, Want, Price, Time FROM Kapi";
...
if(!isset($_POST['submit'])) {
    ...
    while($row = $result->fetch_assoc()) {
          ...
          echo '<td><input class="buttonin" type="button" name="submit'.$id.' " value="Go" onclick="window.location.href=\'Gapi'.$row['Path'].'.php\'" ></td>';
          echo "</tr>";
    $x++;
    $id++;
    }
