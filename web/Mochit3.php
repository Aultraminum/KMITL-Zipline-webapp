...
<center><h1 style="font-size: 70px;">เส้นทางที่3</h1>
<img src="Mochit3.png" width="100%" alt="icon" border="5">
<form>
<input class="button" type="button" value="Home" onclick="window.location.href='Zipline.php'" />
<input class="button" type="button" value="Back" onclick="window.location.href='Mochit.php'" />
</form>
<br><br>
