...
<img src="Siam3.png" width="100%" alt="icon" border="5">
<form>
<input class="button" type="button" value="Home" onclick="window.location.href='Zipline.php'" />
<input class="button" type="button" value="Back" onclick="window.location.href='Siam.php'" />
</form>
<br><br>
<button class="dmbutton" onclick="darker()">Night Mode 🌙</button>
<br><br>
</center>
<a class="button" id="press_me">Like</a>
<script>
