...
<p style="font-size: 30px";>คุณเลือกที่จะไป ซีคอน</p>
<p style="font-size: 30px";>You choose to go to Seacon</p>

<form action="Seacon.php" method="post">
  ความต้องการ :
...
$sql = "SELECT Path, Walk, Taxi, Want, Price, Time FROM Seacon";
...
if(!isset($_POST['submit'])) {
    ...
    while($row = $result->fetch_assoc()) {
          ...
          echo '<td><input class="buttonin" type="button" name="submit'.$id.' " value="Go" onclick="window.location.href=\'Seacon'.$row['Path'].'.php\'" ></td>';
          echo "</tr>";
    $x++;
    $id++;
    }
