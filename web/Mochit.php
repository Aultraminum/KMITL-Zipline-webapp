...
<img height="200" width="200" src="MochitIC.png" alt="icon">
...
<p style="font-size: 30px";>คุณเลือกที่จะไป หมอชิต</p>
<p style="font-size: 30px";>You choose to go to Mochit</p>

<form action="Mochit.php" method="post">
  ความต้องการ :
...
$sql = "SELECT Path, Walk, Taxi, Want, Price, Time FROM Mochit";
...
if(!isset($_POST['submit'])) {
    ...
    while($row = $result->fetch_assoc()) {
          ...
          echo '<td><input class="buttonin" type="button" name="submit'.$id.' " value="Go" onclick="window.location.href=\'Mochit'.$row['Path'].'.php\'" ></td>';
          echo "</tr>";
    $x++;
    $id++;
    }
