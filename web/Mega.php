...
<img height="200" width="200" src="MegaIC.png" alt="icon">
...
<p style="font-size: 30px";>คุณเลือกที่จะไป เมกา บางนา</p>
<p style="font-size: 30px";>You choose to go to Mega Bangna</p>
...
if(!isset($_POST['submit'])) {
    ...
    while($row = $result->fetch_assoc()) {
          ...
          echo '<td><input class="buttonin" type="button" name="submit'.$id.' " value="Go" onclick="window.location.href=\'Mega'.$row['Path'].'.php\'" ></td>';
          echo "</tr>";
    $x++;
    $id++;
    }
